...
class BeesPlots:
    ...
    def __init__(self, p_type = Type.SINGLE):
        if (p_type & self.Type.SINGLE):
            self.figure, self.plot = plt.subplots(nrows=1, ncols=1, figsize=(30, 7.5))
        elif (p_type & self.Type.LEFT):
            self.figure, self.plots = plt.subplots(nrows=1, ncols=2, figsize=(30, 7.5))
        else:
            self.figure, self.plots = plt.subplots(nrows=2, ncols=1, figsize=(60, 15))
        self.twin_count = {}
        self.lines = {}
        self.labels = {}
