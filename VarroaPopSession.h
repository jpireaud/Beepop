...
protected:
	// This defines the output formatter used to save simulation results
	// Default implementation CVarroaPopOutputFormatter will be used if none
	// is explicitely set
	BOOL              m_outputFormatterIsOwn;
	COutputFormatter* m_pOutputFormatter;

public:
	void              SetOutputFormatter(COutputFormatter* pOutputFormatter);
	COutputFormatter& GetOutputFormatter();
...
public:
	...
	// EPA Mortality
	CIEDItem m_IEDItem; // Note:  This variable should be removed but it will
